...
```
git clone --recursive https://github.com/sbrahma0/enpm808x_pid_pair1
...
In your work directory, use cmake to create an Eclipse project for an [out-of-source build] of enpm808x_pid_pair1

```
cd ~/workspace
mkdir -p boilerplate-eclipse
cd boilerplate-eclipse
cmake -G "Eclipse CDT4 - Unix Makefiles" -D CMAKE_BUILD_TYPE=Debug -D CMAKE_ECLIPSE_VERSION=4.7.0 -D CMAKE_CXX_COMPILER_ARG1=-std=c++14 ../enpm808x_pid_pair1/
```
